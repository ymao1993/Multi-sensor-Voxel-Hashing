...
public:
	...
	HRESULT rayIntervalSplatting(ID3D11DeviceContext* context, const VoxelHashData& voxelHashData, const DepthCameraData& depthCameraData, RayCastData& rayCastData, RayCastParams& rayCastParams, unsigned int numVertices);
